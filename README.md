...
latest release. [Switch to the latest release](https://github.com/nholuongut/ansible-role-for-docker/tree/v2.2.0).*
...
`$ ansible-galaxy install nholuong.docker`
...
[user role](https://github.com/nholuong/ansible-user).
